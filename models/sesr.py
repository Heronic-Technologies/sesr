...
tf.compat.v1.flags.DEFINE_bool('relu_act', False, 'Whether to use ReLU activations instead of PReLU activations.')
...
class SESR(tf.keras.Model):
    def __init__(self,
        ...
        if (quant_W and quant_A) or FLAGS.relu_act:
          print(f'{Fore.CYAN}Quantization mode: Using ReLU instead of PReLU activations.')
